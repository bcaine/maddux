...
from maddux.predefined_environments import get_medium_environment
...
def main(desired_iterations, save_path):
    ...
    sim = Planning(get_medium_environment())
    ...
    try:
        for game_idx in range(desired_iterations+1):
            ...
            update_random_prob = game_idx != 0 and game_idx % 100 == 0
            ...
            game = Planning(get_medium_environment())
            game_iterations = 0
...
if __name__ == '__main__':
    ...
    parser.add_argument('--i', dest='iterations', metavar='N', default=1000, type=int, help='number of iterations of RL to run')
